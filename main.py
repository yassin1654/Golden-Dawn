...
def draw_cursor():
    custom_cursor = pygame.image.load('../UI/Pointers/01.png')
...
def main_menu():
    while True:
        ...
        # Add banners
        name_banner = pygame.image.load('../UI/Banners/Banner_Horizontal.png')
        ...
        draw_button(screen, '../UI/Buttons/Button_Hover_3Slides.png', screen.get_width() // 3, screen.get_height() // 2, 200,
                    50, "START")
        draw_button(screen, '../UI/Buttons/Button_Hover_3Slides.png', screen.get_width() // 3, screen.get_height() // 2 + 70,
                    200, 50, "OPTIONS")
        draw_button(screen, '../UI/Buttons/Button_Hover_3Slides.png', screen.get_width() // 3,
...
def options_menu():
    while True:
        screen_bg = pygame.transform.smoothscale(pygame.image.load("../Backgrounds/background.png"), (screen.get_width(), screen.get_height()))
